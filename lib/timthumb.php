...
/* Removed this part so that timthumb can be used for online images: NEMI
// clean params before use
//$src = cleanSource($src);
// last modified time (for caching)
//$lastModified = filemtime($src);
 * Now the filename is generated by name and query string instead of the last modified time of the file: NEMI
 */
$lastModified = $_SERVER['QUERY_STRING'] . $src;
...
if(strlen($src) || file_exists($src)) {
	...
	$height = imagesy($image);
        ...
        /*
         * This part has been removed so that the image can be enlarged: NEMI
